...
export default function MyBookingsSCCompletedLDetails() {
        ...
        <div className="sm:flex sm:flex-row flex-col gap-[30px] mt-[8px] pb-[48px]">
          ...
          <div className=" sm:w-[774px] w-[360px] border border-[#EEF0F3] rounded-2xl bg-white">
            ...
            <div className="py-[20px] px-[20px] border-t border-[#EEF0F3]">
                ...
                <Steps stepNo="02" step={urgentStep} mainTitle="Attendee Assigned" timing="18, June 2023" onClickAction={()=>{setUrgentStep(2)}}>
                ...
                <Steps stepNo="03" step={urgentStep} mainTitle="Attendee Service Started" timing="18, June 2023" onClickAction={()=>{setUrgentStep(3)}}>
       
                </Steps>
                <Steps stepNo="04" step={urgentStep} mainTitle="Lab Reports" timing="18, June 2023" onClickAction={()=>{setUrgentStep(4)}}>      
                <div className='w-full flex justify-between gap-[8px] p-[20px] border-b border-[#EEF0F3]'>
                  <div className="font-Montserrat text-[14px] font-[600]">Lab Test Reports</div>
                  <div className="w-fit"><PrimaryButton title="Download Report" action={()=>{}} /></div>
                </div>   
                </Steps>
