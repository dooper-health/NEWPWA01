...
export default function MyBookingsSCCancelled() {
  ...
  return (
    <div className="">
      ...
      {videoCallPage ? <VideoCall onCallEnd={()=>{setVideoCallPage(false)}}/> :<div className="flex flex-col bg-[#F4F4F4]/50 sm:px-[120px] px-[30px] pt-[24px]">
        ...
        <div className="sm:flex sm:flex-row flex-col gap-[30px] mt-[8px] pb-[48px]">
          ...
          <div className=" sm:w-[774px] w-[360px] border border-[#EEF0F3] rounded-2xl bg-white">
            ...
            <div className="flex flex-col gap-[24px] py-[20px] px-[20px] border-t border-[#EEF0F3]">
                <div className="sm:flex sm:justify-between w-full p-[20px]">
